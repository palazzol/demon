...
; Moniker - Z80 Version
; by Frank Palazzolo
; For Space Raider - CPU2
;
        .area   CODE1   (ABS)   ; ASXXXX directive, absolute addressing

DATAIN	.equ	0x2000		; where to read data in from

CMDBUF  .equ    0x63f0      ; Need only 4 bytes of ram for command buffer
