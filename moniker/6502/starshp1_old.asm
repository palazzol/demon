...
IOREGR	.equ	SCHIP+0x0400	;reserved region for IO Read
IOREGW	.equ	SCHIP+0x0500	;reserved region for IO Write
...
;        .ds     0x0500,0xff       ; fill front and io read region with $FF
        ...
        .org     SCHIP+0x0600     ;code starts here
